...
export const Cart: React.FC = () => {
  ...
  // Initial state now reflects actual products from the Scent Collection
  const [items, setItems] = useState<CartItem[]>([
    {
      ...
      edition: 'Series 04',
      type: 'Parfum',
      glowColor: 'rgba(242,208,13,0.3)' // Gold
    },
    {
      id: '01', // Matches CRISP
      name: 'CRISP',
      ...
      edition: 'Series 01',
      type: 'Eau de Parfum',
      glowColor: 'rgba(100, 255, 218, 0.2)' // Cyan/Greenish
    },
    {
      id: '03', // Matches EYES
      name: 'EYES',
      ...
      edition: 'Series 03',
      type: 'Extrait',
      glowColor: 'rgba(236, 72, 153, 0.25)' // Purple/Pink
    }
  ]);

  const [deletingId, setDeletingId] = useState<string | null>(null);

  // Auto-focus the scroll container on mount to enable keyboard scrolling immediately
  useEffect(() => {
  ...
  return (
    <div className="min-h-full w-full pt-28 px-6 pb-32 flex flex-col animate-fade-in">
      ...
      <div 
        ...
        tabIndex={0}
        className="flex overflow-x-auto gap-5 pb-8 -mx-6 px-6 scrollbar-hide snap-x snap-mandatory min-h-[420px] focus:outline-none touch-pan-x"
      >
        {items.length === 0 ? (
